	...
	public class ActionInteractionCheck : ActionCheck
	{
		...
		override public bool CheckCondition ()
		{
			...
			if (interactionType == InteractionType.Use)
			{
				...
				{
					ACDebug.LogWarning ("Cannot check Hotspot " + hotspot.gameObject.name + "'s Use button " + number.ToString () + " because it doesn't exist!", hotspot);
				}
			}
			...
			else if (interactionType == InteractionType.Inventory)
			{
				...
				{
					ACDebug.LogWarning ("Cannot check Hotspot " + hotspot.gameObject.name + "'s Inventory button " + number.ToString () + " because it doesn't exist!", hotspot);
				}
			}
