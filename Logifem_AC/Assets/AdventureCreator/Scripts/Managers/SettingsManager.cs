	...
	public class SettingsManager : ScriptableObject
	{
		...
		private void ShowInterfaceSettings ()
		{
			...
			if (showInterface)
			{
				...
				{
					defaultMouseClicks = CustomGUILayout.ToggleLeft ("Left and right mouse clicks have default functionality?", defaultMouseClicks, "AC.KickStarter.settingsManager.defaultMouseClicks", "If True, then left and right mouse clicks will have default behaviour");
				}
