...
namespace AC
{
	...
	public class EventManager : MonoBehaviour
	{
		...
		/** <summary>Triggers the OnCompleteSpeechScroll event.</summary>
		 * <param name = "speakingCharacter">The character who is speaking. If null, the line is considered to be a narration</param>
		 * <param name = "speechText">The dialogue text</param>
		 * <param name = "lineID">The ID number of the speech line, as generated by the SpeechManager</param>
		 */
		public void Call_OnCompleteSpeechScroll (AC.Char speakingCharacter, string speechText, int lineID)
		{
		 ...
		 */
		public void Call_OnSpeechToken (AC.Char speakingCharacter, int lineID, string tokenKey, string tokenValue)
		{
			if (OnSpeechToken != null)
			{
				OnSpeechToken (speakingCharacter, lineID, tokenKey, tokenValue);
			}
		}
